...
export default function ISGCozumleriKatalog() {
  const pdfUrl = "/pdfs/isg-cozumleri.pdf";
      ...
      <div className="bg-white border-b sticky top-16 z-40">
        <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href={pdfUrl} download="ISG-Cozumleri-Katalog.pdf">
              <Button size="sm">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="sm:hidden p-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <a href={pdfUrl} download="ISG-Cozumleri-Katalog.pdf" className="block">
